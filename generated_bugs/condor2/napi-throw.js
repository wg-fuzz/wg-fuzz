...
async function init() {
    ...
    const render_pipeline104 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module007_code = await fs.readFile('shader_module007.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline0010 = await device00.createRenderPipelineAsync({
    ...
    try {
        shader_module107_code = await fs.readFile('shader_module107.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module008_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module006.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module106.getCompilationInfo();
    ...
    const render_pipeline0014 = await device00.createRenderPipelineAsync({
    ...
    try {
        shader_module009_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline0016 = await device00.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module009.getCompilationInfo();
    ...
    try {
        shader_module108_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline1010 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline0018 = await device00.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module008.getCompilationInfo();
    ...
    const render_pipeline0020 = await device00.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module108.getCompilationInfo();
    ...
    try {
        shader_module109_code = await fs.readFile('shader_module109.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module109.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module105.getCompilationInfo();
    ...
    const render_pipeline0021 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline1014 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline0022 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline1016 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1017 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1018 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1019 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1020 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1021 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module205_code = await fs.readFile('shader_module205.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module205 = await device20.createShaderModule({ label: "shader_module205", code: shader_module205_code })

    const render_pipeline1022 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module1010_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module206_code = await fs.readFile('shader_module206.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline1023 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module207_code = await fs.readFile('shader_module207.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module208_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module209_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module2010_code = await fs.readFile('shader_module2010.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline0026 = await device00.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module209.getCompilationInfo();
    ...
    try {
        shader_module1011_code = await fs.readFile('shader_module1011.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module401.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module206.getCompilationInfo();
    ...
    try {
        shader_module2011_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module2011.getCompilationInfo();
    ...
    try {
        shader_module2012_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module107.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module402.getCompilationInfo();
    ...
    try {
        shader_module1012_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    {
        const shaderInfo = await shader_module205.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module1012.getCompilationInfo();
    ...
    try {
        shader_module0010_code = await fs.readFile('shader_module0010.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline401 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline1024 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline402 = await device40.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module0010.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module1010.getCompilationInfo();
    ...
    const render_pipeline0032 = await device00.createRenderPipelineAsync({
    ...
    try {
        shader_module0011_code = await fs.readFile('shader_module0011.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module2013_code = await fs.readFile('shader_module2013.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module2013 = await device20.createShaderModule({ label: "shader_module2013", code: shader_module2013_code })

    const render_pipeline0033 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline0034 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline1025 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module2014_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module2014 = await device20.createShaderModule({ label: "shader_module2014", code: shader_module2014_code })

    const render_pipeline403 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline1026 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline208 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline0035 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline0036 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline0037 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline2010 = await device20.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module207.getCompilationInfo();
    ...
    const render_pipeline2011 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline2012 = await device20.createRenderPipelineAsync({
    ...
    try {
        shader_module1013_code = await fs.readFile('shader_module1013.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module1013 = await device10.createShaderModule({ label: "shader_module1013", code: shader_module1013_code })

    const render_pipeline0038 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline0039 = await device00.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module403.getCompilationInfo();
    ...
    const render_pipeline2013 = await device20.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module2010.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module0011.getCompilationInfo();
    ...
    const render_pipeline2014 = await device20.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module1011.getCompilationInfo();
    ...
    {
        const shaderInfo = await shader_module007.getCompilationInfo();
    ...
    const render_pipeline2015 = await device20.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module2014.getCompilationInfo();
    ...
    const render_pipeline407 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline408 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline1027 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline2016 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline2017 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline409 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline1028 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module602_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module404_code = await fs.readFile('shader_module404.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline0040 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline2018 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline4010 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline2019 = await device20.createRenderPipelineAsync({
    ...
    const render_pipeline0041 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline1029 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module405_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module603_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    const shader_module603 = await device60.createShaderModule({ label: "shader_module603", code: shader_module603_code })

    const render_pipeline1030 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1031 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline4011 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline4012 = await device40.createRenderPipelineAsync({
    ...
    const render_pipeline0042 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline2020 = await device20.createRenderPipelineAsync({
    ...
    try {
        shader_module800_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    try {
        shader_module406_code = await fs.readFile('shader_module406.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline1032 = await device10.createRenderPipelineAsync({
    ...
    try {
        shader_module407_code = await fs.readFile('render_shader.wgsl', 'utf8');
    } catch (err) {
        console.log(err);
    }
    ...
    const render_pipeline1033 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1034 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline0043 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline1035 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1036 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline1037 = await device10.createRenderPipelineAsync({
    ...
    const render_pipeline0044 = await device00.createRenderPipelineAsync({
    ...
    const render_pipeline2021 = await device20.createRenderPipelineAsync({
    ...
    {
        const shaderInfo = await shader_module800.getCompilationInfo();
